...
Real category IDs below came from a live "Debug fetch" run against the
source site's search endpoint (state.search.aggregations.categories,
including one level of sub_categories) -- not guessed. See docs/RESEARCH.md §10.
